...
void* allocation(double **MatrC,int colonne,int ligne){


MatrC=(double **)malloc(ligne*sizeof(double *));
...
double **add_matrice(double **MatrA,double **MatrB ,int colonne,int ligne){
